...
- [rsgain v3.8 portable ZIP (x64)](https://github.com/complexlogic/rsgain/releases/download/v3.8/rsgain-3.8-win64.zip)
...
- [rsgain v3.8 portable ZIP (Apple Silicon)](https://github.com/complexlogic/rsgain/releases/download/v3.8/rsgain-3.8-macOS-arm64.zip)
- [rsgain v3.8 portable ZIP (Intel)](https://github.com/complexlogic/rsgain/releases/download/v3.8/rsgain-3.8-macOS-x86_64.zip)
...
```bash
wget https://github.com/complexlogic/rsgain/releases/download/v3.8/rsgain_3.8-1_amd64.deb
sudo apt install ./rsgain_3.8-1_amd64.deb
```
...
- [rsgain v3.8 portable TAR (x86_64)](https://github.com/complexlogic/rsgain/releases/download/v3.8/rsgain-3.8-Linux.tar.xz)
